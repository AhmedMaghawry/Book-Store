...
if (isset($_GET['username']) && isset($_GET['password']) && isset($_GET['fiName']) && isset($_GET['laName']) && isset($_GET['email']) && isset($_GET['phone']) && isset($_GET['shi'])) {
    ...
    $res = mysqli_query($con2, "update Book_Store.Manager set username = '$User', password = '$Pass', firstname = '$First', lastname = '$Last', email = '$Email', phone = '$Phone', shipping_address = '$Shi' where username = '$User';");
